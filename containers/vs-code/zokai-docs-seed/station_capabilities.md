...
| Demo | What You See | Duration | YouTube |
|------|-------------|----------|---------|
| **📊 One-Prompt Slide Deck** | One prompt triggers Calendar MCP + mcp-tasks + code generation → dark-themed HTML slide deck previewed in Browse Lite | 44s | [▶ Watch](https://youtu.be/bqTI-GP8rkk) |
| **📰 Newsletter Digest** | Agent reads newsletters from Gmail, synthesizes across sources, fact-checks with web research, drafts a professional email, then creates a reusable markdown template | 2m | [▶ Watch](https://youtu.be/klV9WiVHHso) |
| **🔍 Commission Invoice Controller** | Agent audits a commission invoice PDF → extracts rates → cross-checks against Postgres database → catches €16,000 in phantom contracts → drafts response email + creates SOP template | 2m | [▶ Watch](https://youtu.be/tirmY4EfeqA) |
...
> 📺 [▶ Watch on YouTube](https://youtu.be/bqTI-GP8rkk) (44s)
...
> 📺 [▶ Watch on YouTube](https://youtu.be/klV9WiVHHso) (2 min)
...
> 📺 [▶ Watch on YouTube](https://youtu.be/tirmY4EfeqA) (2 min)
