...
**See it in action — real workflow demos (no editing, no faking):**

| Demo | What You See | Duration |
|------|-------------|----------|
| 📊 **One-Prompt Slide Deck** | One prompt → Calendar + tasks + code → HTML slide deck | 44s — [▶ Watch](https://youtu.be/bqTI-GP8rkk) |
| 📰 **Newsletter Digest** | Agent reads Gmail Newsletter, synthesizes, fact-checks, drafts email, creates template | 2m — [▶ Watch](https://youtu.be/klV9WiVHHso) |
| 🔍 **Invoice Controller** | Audits PDF → cross-checks Postgres → catches €16k in phantom contracts → drafts response | 2m — [▶ Watch](https://youtu.be/tirmY4EfeqA) |
